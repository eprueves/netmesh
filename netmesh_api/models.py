...
class DataPoint(models.Model):
    ...
    baseline_rtt = models.BigIntegerField(null=True)
    bottleneck_bw = models.BigIntegerField(null=True)
    bdp = models.BigIntegerField(null=True)
    min_rwnd = models.BigIntegerField(null=True)
    ave_tcp_tput = models.BigIntegerField(null=True)
    itt = models.BigIntegerField(null=True)
    tcp_ttr = models.BigIntegerField(null=True)
    trans_bytes = models.BigIntegerField(null=True)
    retrans_bytes = models.BigIntegerField(null=True)
    tcp_eff = models.BigIntegerField(null=True)
    ave_rtt = models.BigIntegerField(null=True)
    buffer_delay = models.BigIntegerField(null=True)
